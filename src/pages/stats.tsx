            ...
            <div className="flex flex-col gap-8 pb-8">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-base flex items-center gap-2">
                                <Clock className="h-4 w-4 text-blue-500" /> Avg.
                                Latency (ms)
                            </CardTitle>
                            <CardDescription>
                    ...
                    <div className="md:col-span-3 flex flex-col gap-4">
                        <Card className="flex-1 bg-muted/20 border-none">
                            ...
                            <CardContent>
                                ...
                                <div className="text-xs text-muted-foreground mt-1">
                                    {fastestModel?.avgTTFT.toFixed(0)}ms initial
                                    latency
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="flex-1 bg-muted/20 border-none">
                            ...
                            <CardContent>
                                ...
                                <div className="text-xs text-muted-foreground mt-1">
                                    {topRatingModel?.avgRating.toFixed(1)} / 5.0
                                    avg score
                                </div>
                            </CardContent>
                        </Card>
                ...
                {modelStats.length === 0 && (
                    <div className="flex flex-col items-center justify-center py-20 bg-muted/10 border-2 border-dashed rounded-xl">
                        ...
                        <p className="text-sm text-muted-foreground/60 max-w-xs text-center mt-2">
                            Start some conversations in the Arena to populate
                            these performance benchmarks.
                        </p>
                    </div>
                )}
            </div>
