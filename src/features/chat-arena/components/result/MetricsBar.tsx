...
export function MetricsBar({ metrics, ranges }: MetricsBarProps) {
    ...
    return (
        <div className="flex items-center gap-4 text-xs font-mono text-muted-foreground tabular-nums pt-3 mt-1 px-1 opacity-70 border-t border-dashed border-border/40 flex-wrap">
            <div
