...
const DialogHeader = ({
    ...
    <div
        className={cn(
            'flex flex-col space-y-1.5 text-left p-4 pb-3 border-b bg-muted/30',
            className
        )}
        {...props}
    />
...
const DialogFooter = ({
    ...
    <div
        className={cn(
            'flex flex-col-reverse sm:flex-row sm:justify-end sm:gap-2 p-4 pt-3 border-t bg-muted/20',
            className
        )}
        {...props}
    />
